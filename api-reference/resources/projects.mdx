...
<CodeGroup>
```bash Request
curl -X GET "https://api.varocloud.io/v1/projects?per_page=20" \
...
<CodeGroup>
```bash Request
curl -X POST "https://api.varocloud.io/v1/projects" \
  -H "Authorization: Bearer YOUR_API_KEY" \
...
<CodeGroup>
```bash Request
curl -X GET "https://api.varocloud.io/v1/projects/proj_abc123" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
<CodeGroup>
```bash Request
curl -X PUT "https://api.varocloud.io/v1/projects/proj_abc123" \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
...
<CodeGroup>
```bash Request
curl -X DELETE "https://api.varocloud.io/v1/projects/proj_abc123" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
</CodeGroup>
