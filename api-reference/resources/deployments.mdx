...
<CodeGroup>
```bash Request
curl -X GET "https://api.varocloud.io/v1/deployments?project_id=proj_abc123&environment=production&per_page=20" \
...
<CodeGroup>
```bash Request
curl -X GET "https://api.varocloud.io/v1/deployments/dep_xyz789" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
<CodeGroup>
```bash Request
curl -X GET "https://api.varocloud.io/v1/deployments/dep_xyz789/logs" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
<CodeGroup>
```bash Request
curl -X POST "https://api.varocloud.io/v1/deployments/dep_xyz789/rollback" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
<CodeGroup>
```bash Request
curl -X POST "https://api.varocloud.io/v1/deployments/dep_mno345/cancel" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
