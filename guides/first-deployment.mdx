...
<Steps>
  <Step title="Open your project">
    Log in to [app.varocloud.io](https://app.varocloud.io) and select the project you want to deploy from the Projects list on your home screen.
  </Step>
...
```bash
curl https://api.varocloud.io/v1/deployments/dep_xyz789 \
  -H "Authorization: Bearer YOUR_API_KEY"
```
